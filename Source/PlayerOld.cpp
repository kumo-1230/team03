...
//更新処理
void PlayerOld::Update(float elapsedTime, Camera* camera)
{
	//カメラ初期化
...
//描画処理
void PlayerOld::Render(const RenderContext& rc, ModelRenderer* renderer)
{
	//エフェクト更新処理
...
void PlayerOld::RenderDebugPrimitive(const RenderContext& rc, ShapeRenderer* renderer)
{
	//基底クラスの関数呼び出し
