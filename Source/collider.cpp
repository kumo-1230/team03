...
// ============================================================================
// BoxCollider Helper - OBB vertices
// ============================================================================
...
// ============================================================================
// AABBCollider Helper - World bounds
// ============================================================================
...
// ============================================================================
// CapsuleCollider Helper - Cylinder segment
// ============================================================================
...
static bool CheckSphereVsAabbSimple(
...
static bool CheckSphereVsAabbRigidbody(
    const SphereCollider* sphere,
    const AABBCollider* aabb,
    DirectX::XMFLOAT3& out_correction) {
    DirectX::XMFLOAT3 sphere_center = sphere->GetWorldCenter();
...
static bool CheckSphereVsCylinderSimple(
    const SphereCollider* sphere,
...
static bool CheckSphereVsCylinderRigidbody(
    const SphereCollider* sphere,
    const CapsuleCollider* cylinder,
    DirectX::XMFLOAT3& out_correction) {
    DirectX::XMFLOAT3 sphere_center = sphere->GetWorldCenter();
...
static bool CheckAabbVsAabbSimple(
...
static bool CheckAabbVsAabbRigidbody(
    const AABBCollider* aabb_a,
    const AABBCollider* aabb_b,
    DirectX::XMFLOAT3& out_correction) {
    DirectX::XMFLOAT3 min_a, max_a, min_b, max_b;
...
static bool CheckBoxVsAabbSimple(
    const BoxCollider* box,
    const AABBCollider* aabb) {
...
static bool CheckBoxVsAabbRigidbody(
    const BoxCollider* box,
    const AABBCollider* aabb,
    DirectX::XMFLOAT3& out_correction) {
...
static bool CheckBoxVsCylinderSimple(
    const BoxCollider* box,
    const CapsuleCollider* cylinder) {
...
static bool CheckBoxVsCylinderRigidbody(
    const BoxCollider* box,
    const CapsuleCollider* cylinder,
    DirectX::XMFLOAT3& out_correction) {
...
static bool CheckAabbVsCylinderSimple(
    const AABBCollider* aabb,
    const CapsuleCollider* cylinder) {
    // Get cylinder segment
    DirectX::XMFLOAT3 cylinder_start, cylinder_end;
...
static bool CheckAabbVsCylinderRigidbody(
    const AABBCollider* aabb,
    const CapsuleCollider* cylinder,
    DirectX::XMFLOAT3& out_correction) {
    DirectX::XMFLOAT3 cylinder_start, cylinder_end;
...
static bool CheckCylinderVsCylinderSimple(
...
static bool CheckCylinderVsCylinderRigidbody(
    const CapsuleCollider* cylinder_a,
    const CapsuleCollider* cylinder_b,
    DirectX::XMFLOAT3& out_correction) {
    DirectX::XMFLOAT3 a_start, a_end, b_start, b_end;
...
bool SphereCollider::CheckCollision(const Collider* other, GameObject*& out_other) const {
    ...
    case ColliderType::kAabb:
        has_collision = CheckSphereVsAabbSimple(this, static_cast<const AABBCollider*>(other));
        break;
    case ColliderType::kCapsule:
        has_collision = CheckSphereVsCylinderSimple(this, static_cast<const CapsuleCollider*>(other));
        break;
    }
...
bool SphereCollider::CheckRigidbodyCollision(const Collider* other, DirectX::XMFLOAT3& out_correction, GameObject*& out_other) const {
    ...
    case ColliderType::kBox:
        ...
        break;
    case ColliderType::kAabb:
        has_collision = CheckSphereVsAabbRigidbody(this, static_cast<const AABBCollider*>(other), out_correction);
        break;
    case ColliderType::kCapsule:
        has_collision = CheckSphereVsCylinderRigidbody(this, static_cast<const CapsuleCollider*>(other), out_correction);
        break;
    }
...
// ============================================================================
// BoxCollider Implementation (OBB)
// ============================================================================
...
bool BoxCollider::CheckCollision(const Collider* other, GameObject*& out_other) const {
    ...
    case ColliderType::kBox:
        ...
        break;
    case ColliderType::kAabb:
        has_collision = CheckBoxVsAabbSimple(this, static_cast<const AABBCollider*>(other));
        break;
    case ColliderType::kCapsule:
        has_collision = CheckBoxVsCylinderSimple(this, static_cast<const CapsuleCollider*>(other));
        break;
    }
...
bool BoxCollider::CheckRigidbodyCollision(const Collider* other, DirectX::XMFLOAT3& out_correction, GameObject*& out_other) const {
    ...
    case ColliderType::kBox:
        ...
        break;
    case ColliderType::kAabb:
        has_collision = CheckBoxVsAabbRigidbody(this, static_cast<const AABBCollider*>(other), out_correction);
        break;
    case ColliderType::kCapsule:
        has_collision = CheckBoxVsCylinderRigidbody(this, static_cast<const CapsuleCollider*>(other), out_correction);
        break;
    }
...
bool AABBCollider::CheckCollision(const Collider* other, GameObject*& out_other) const {
    ...
    switch (other->GetType()) {
    case ColliderType::kSphere:
        has_collision = CheckSphereVsAabbSimple(static_cast<const SphereCollider*>(other), this);
        break;
    case ColliderType::kBox:
        has_collision = CheckBoxVsAabbSimple(static_cast<const BoxCollider*>(other), this);
        break;
    case ColliderType::kAabb:
        has_collision = CheckAabbVsAabbSimple(this, static_cast<const AABBCollider*>(other));
        break;
    case ColliderType::kCapsule:
        has_collision = CheckAabbVsCylinderSimple(this, static_cast<const CapsuleCollider*>(other));
        break;
    }
...
bool AABBCollider::CheckRigidbodyCollision(const Collider* other, DirectX::XMFLOAT3& out_correction, GameObject*& out_other) const {
    if (!other || !other->IsEnabled() || !IsEnabled()) {
        return false;
    }
    ...
    switch (other->GetType()) {
    case ColliderType::kSphere:
        has_collision = CheckSphereVsAabbRigidbody(static_cast<const SphereCollider*>(other), this, out_correction);
        if (has_collision) {
            out_correction.x = -out_correction.x;
            out_correction.y = -out_correction.y;
            out_correction.z = -out_correction.z;
        ...
        break;
    case ColliderType::kBox:
        has_collision = CheckBoxVsAabbRigidbody(static_cast<const BoxCollider*>(other), this, out_correction);
        if (has_collision) {
            out_correction.x = -out_correction.x;
            out_correction.y = -out_correction.y;
            out_correction.z = -out_correction.z;
        ...
        break;
    case ColliderType::kAabb:
        has_collision = CheckAabbVsAabbRigidbody(this, static_cast<const AABBCollider*>(other), out_correction);
        break;
    case ColliderType::kCapsule:
        has_collision = CheckAabbVsCylinderRigidbody(this, static_cast<const CapsuleCollider*>(other), out_correction);
        break;
    }
...
// ============================================================================
// CapsuleCollider Implementation (Cylinder)
// ============================================================================
...
bool CapsuleCollider::CheckCollision(const Collider* other, GameObject*& out_other) const {
    ...
    switch (other->GetType()) {
    case ColliderType::kSphere:
        has_collision = CheckSphereVsCylinderSimple(static_cast<const SphereCollider*>(other), this);
        break;
    case ColliderType::kBox:
        has_collision = CheckBoxVsCylinderSimple(static_cast<const BoxCollider*>(other), this);
        break;
    case ColliderType::kAabb:
        has_collision = CheckAabbVsCylinderSimple(static_cast<const AABBCollider*>(other), this);
        break;
    case ColliderType::kCapsule:
        has_collision = CheckCylinderVsCylinderSimple(this, static_cast<const CapsuleCollider*>(other));
        break;
    }
...
bool CapsuleCollider::CheckRigidbodyCollision(const Collider* other, DirectX::XMFLOAT3& out_correction, GameObject*& out_other) const {
    ...
    switch (other->GetType()) {
    case ColliderType::kSphere:
        has_collision = CheckSphereVsCylinderRigidbody(static_cast<const SphereCollider*>(other), this, out_correction);
        if (has_collision) {
            out_correction.x = -out_correction.x;
            out_correction.y = -out_correction.y;
            out_correction.z = -out_correction.z;
        ...
        break;
    case ColliderType::kBox:
        has_collision = CheckBoxVsCylinderRigidbody(static_cast<const BoxCollider*>(other), this, out_correction);
        if (has_collision) {
            out_correction.x = -out_correction.x;
            out_correction.y = -out_correction.y;
            out_correction.z = -out_correction.z;
        ...
        break;
    case ColliderType::kAabb:
        has_collision = CheckAabbVsCylinderRigidbody(static_cast<const AABBCollider*>(other), this, out_correction);
        if (has_collision) {
            out_correction.x = -out_correction.x;
            out_correction.y = -out_correction.y;
            out_correction.z = -out_correction.z;
        ...
        break;
    case ColliderType::kCapsule:
        has_collision = CheckCylinderVsCylinderRigidbody(this, static_cast<const CapsuleCollider*>(other), out_correction);
        break;
    }
